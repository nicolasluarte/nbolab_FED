...
cmdClock = 'sudo pio run -d ~/repos/nbolab_FED/fed_programs/FED_set_clock -t upload'
os.system(cmdClock)
print(pyfiglet.figlet_format("CLOCK SYNC DONE!"))

print(pyfiglet.figlet_format("FED DELAY CONTROL"))
cmdDelayControl = 'sudo pio run -d ~/repos/nbolab_FED/fed_programs/FED_delay_control -t upload'
